...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="/PARCIAL3333/html/dist/css/adminlte.min.css">
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>GYM</b>COL</a>
    </div>
    <div class="card-body">
        ...
        if(isset($_GET["m"])){
          switch($_GET["m"]){
            ...
            <div class="alert-warning" role="alert">
              Por favor diligencias los campos que estan vacios!
            </div>
            <?php
            break;          
          }
      ...
      ?>
        ...
        <div class="input-group mb-3">
          <input type="date" name="fecha_crea" id="fecha_crea" class="form-control" placeholder="fecha_creación">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <a href="/PARCIAL3333/views/404.php" id="enviar"class="small">Forgot Password?</a>
                
            </div>
            <div class="text-center">
            <a href="/PARCIAL3333/index.php" id="enviar"class="small">Already have an account?</a>
