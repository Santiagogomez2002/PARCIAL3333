    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo BASE_URL; ?>../views/inicio.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Inicio</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo BASE_URL; ?>../views/perfil.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Perfil</p>
            </a>
          </li>                 
          ...
          <li class="nav-item">
            <a href="<?php echo BASE_URL; ?>../views/Logout.php" class="nav-link">
